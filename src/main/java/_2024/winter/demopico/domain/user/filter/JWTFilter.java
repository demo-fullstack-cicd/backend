package _2024.winter.demopico.domain.user.filter;

import _2024.winter.demopico.domain.user.dto.userDetails.RoleUserDetails;
import _2024.winter.demopico.domain.user.dto.userDetails.UserAccessDto;
...
public class JWTFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (requestURI.startsWith("/h2") || requestURI.startsWith("/favicon") || requestURI.startsWith("/api/health")|| requestURI.startsWith("/api/reissue")) {
